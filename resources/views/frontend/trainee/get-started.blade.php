...
@section('content')
    ...
    <section class="mainBanner">
        ...
        <ul>
            ...
            <li>
                <a href="{{route('routes.training')}}" class="active">  {{translate('التقدم لطلب تدريب')}}</a>
            </li>
        </ul>
        <figure>
                ...
                <div class="col-md-4 p-2">
                    ...
                    <div class="supportFaq">
                        <div class="headTitle text-start wow fadeInUp">
                            <h1> {{translate('تفاصيل التدريب')}} </h1>
                        </div>
                                    ...
                                    <div id="question{{$key}}" class="accordion-collapse collapse @if($key==0) show @endif" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <p>            <i class="fas fa-dot-circle small" style="color: #A505A"></i> {{' - '.$val }}</p>
                                                @endforeach
                                            </div>
                                            <h6 class=" secondaryTitle">
