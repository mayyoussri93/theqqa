...
@section('content')
    ...
    <section  class="mainBanner" >
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{url()->current()}}" class="active"  style="color: #A505A">  {{translate('نقل الكفالة')}} </a>
...
{{--                                <select  id="job" name="job" class="select2WithoutSearch">--}}
{{--                                    <option value="" selected > {{translate('الكل')}} </option>--}}
...
{{--                            </div>--}}
                ...
                <div class="col-sm-2 col-md-4 p-2 d-flex align-items-center justify-content-end flex-wrap">
                    <a href="{{route('allSponsorCvs')}}" id="SearchResetButton" type="button" class=" btn clear m-1 " style="display: none"> {{translate('مسح')}}
                        <span></span>
                    </a>
        ...
        <div class="container">
            <div >
                    ...
                    <div  class="row" id="hereWillDisplayAllWorker">
                        @include('frontend.reservation.reservation_sponsor_worker.workers_page')
                    </div>
...
// Watch More Link click handlers
 ...
 <div class="col-sm-6 col-md-6 col-lg-4 p-2 loader_html">
        ...
        //load more script
        var new_page = 1;
        var url = '{{route('allSponsorCvs')}}';

        var link_only = '{{route('allSponsorCvs')}}';
        ...
        function loadMoreData(new_page) {
            url = link_only + "?page=" + new_page + "&age=" + age + "&nationality=" + nationality
            $.ajax({
                url: url,
                type: 'GET',
                beforeSend: function () {
