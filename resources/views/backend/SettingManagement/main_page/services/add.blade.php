    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">{{translate('اضافة خدمتنا')}}</h3>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{translate('الصفحة الرئيسية')}}</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{translate('بيانات الصفحة الرئيسية')}}</a></li>
                    <li class="breadcrumb-item active">{{translate('خدمتنا')}}</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="{{ route('services.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="url" class="form-control" id="validationCustom02" name="link"
                                                       placeholder="{{translate('الرابط')}}" value="{{old('link')}}" >
                                                <div class="valid-feedback">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea name="description" rows="5" class="form-control"
                                                          ...
                                                          id="validationCustomUsername" required></textarea>
